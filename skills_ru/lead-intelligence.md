...
### Required
- **Exa MCP** 鈥?Deep web search for people, companies, and signals (`web_search_exa`)
- **X API** 鈥?Follower/following graph, mutual analysis, recent activity (`X_BEARER_TOKEN`, plus write-context credentials such as `X_CONSUMER_KEY`, `X_CONSUMER_SECRET`, `X_ACCESS_TOKEN`, `X_ACCESS_TOKEN_SECRET`)

### Optional (enhance results)
- **LinkedIn** 鈥?Direct API if available, otherwise browser control for search, profile inspection, and drafting
- **Apollo/Clay API** 鈥?For enrichment cross-reference if user has access
- **GitHub MCP** 鈥?For developer-centric lead qualification
- **Apple Mail / Mail.app** 鈥?Draft cold or warm email without sending automatically
- **Browser control** 鈥?For LinkedIn and X when API coverage is missing or constrained

## Pipeline Overview

```
鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?鈹?1. Signal   鈹傗攢鈹€鈹€鈹€>鈹?2. Mutual    鈹傗攢鈹€鈹€鈹€>鈹?3. Warm Path    鈹傗攢鈹€鈹€鈹€>鈹?4. Enrich    鈹傗攢鈹€鈹€鈹€>鈹?5. Outreach     鈹?鈹?   Scoring  鈹?    鈹?   Ranking   鈹?    鈹?   Discovery    鈹?    鈹?             鈹?    鈹?   Draft        鈹?鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?```
...
| Factor | Weight |
|--------|--------|
| Number of connections to targets | 40% 鈥?highest weight, most connections = highest rank |
| Mutual's current role/company | 20% 鈥?decision maker vs individual contributor |
| Mutual's location | 15% 鈥?same city = easier intro |
| Industry alignment | 15% 鈥?same vertical = natural intro |
| Mutual's X handle / LinkedIn | 10% 鈥?identifiability for outreach |
...
```text
B(m) = 危_{t 鈭?T} w(t) 路 位^(d(m,t) - 1)
R(m) = B_ext(m) 路 (1 + 尾 路 engagement(m))
```
...
```
You 鈹€鈹€[follows]鈹€鈹€> Mutual A 鈹€鈹€[invested in]鈹€鈹€> Target Company
You 鈹€鈹€[follows]鈹€鈹€> Mutual B 鈹€鈹€[co-founded with]鈹€鈹€> Target Person
You 鈹€鈹€[met at]鈹€鈹€> Event 鈹€鈹€[also attended]鈹€鈹€> Target Person
```

### Path Types (ordered by warmth)
1. **Direct mutual** 鈥?You both follow/know the same person
2. **Portfolio connection** 鈥?Mutual invested in or advises target's company
3. **Co-worker/alumni** 鈥?Mutual worked at same company or attended same school
4. **Event overlap** 鈥?Both attended same conference/program
5. **Content engagement** 鈥?Target engaged with mutual's content or vice versa
...
- Recent X posts (last 30 days) 鈥?topics, tone, interests
...
- **signal-scorer** 鈥?Searches and ranks prospects by relevance signals
- **mutual-mapper** 鈥?Maps social graph connections and finds warm paths
- **enrichment-agent** 鈥?Pulls detailed profile and company data
- **outreach-drafter** 鈥?Generates personalized messages
