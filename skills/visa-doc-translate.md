...
- Bank deposit certificates (瀛樻璇佹槑)
- Income certificates (鏀跺叆璇佹槑)
- Employment certificates (鍦ㄨ亴璇佹槑)
- Retirement certificates (閫€浼戣瘉鏄?
- Property certificates (鎴夸骇璇佹槑)
- Business licenses (钀ヤ笟鎵х収)
