...
Understand scalar vs list context 鈥?a core Perl concept.
...
Infix type-check 鈥?replaces `blessed($o) && $o->isa('X')`.
...
open FH, "< $path";        # Still bad 鈥?user data in mode string
```
...
鈹溾攢鈹€ lib/
鈹?  鈹斺攢鈹€ MyApp/
鈹?      鈹溾攢鈹€ App.pm           # Main module
鈹?      鈹溾攢鈹€ Config.pm        # Configuration
鈹?      鈹溾攢鈹€ DB.pm            # Database layer
鈹?      鈹斺攢鈹€ Util.pm          # Utilities
鈹溾攢鈹€ bin/
鈹?  鈹斺攢鈹€ myapp                # Entry-point script
鈹溾攢鈹€ t/
鈹?  鈹溾攢鈹€ 00-load.t            # Compilation tests
鈹?  鈹溾攢鈹€ unit/                # Unit tests
鈹?  鈹斺攢鈹€ integration/         # Integration tests
鈹溾攢鈹€ cpanfile                 # Dependencies
鈹溾攢鈹€ Makefile.PL              # Build system
鈹斺攢鈹€ .perlcriticrc            # Linting config
```
