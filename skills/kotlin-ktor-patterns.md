...
src/main/kotlin/
鈹溾攢鈹€ com/example/
鈹?  鈹溾攢鈹€ Application.kt           # Entry point, module configuration
鈹?  鈹溾攢鈹€ plugins/
鈹?  鈹?  鈹溾攢鈹€ Routing.kt           # Route definitions
鈹?  鈹?  鈹溾攢鈹€ Serialization.kt     # Content negotiation setup
鈹?  鈹?  鈹溾攢鈹€ Authentication.kt    # Auth configuration
鈹?  鈹?  鈹溾攢鈹€ StatusPages.kt       # Error handling
鈹?  鈹?  鈹斺攢鈹€ CORS.kt              # CORS configuration
鈹?  鈹溾攢鈹€ routes/
鈹?  鈹?  鈹溾攢鈹€ UserRoutes.kt        # /users endpoints
鈹?  鈹?  鈹溾攢鈹€ AuthRoutes.kt        # /auth endpoints
鈹?  鈹?  鈹斺攢鈹€ HealthRoutes.kt      # /health endpoints
鈹?  鈹溾攢鈹€ models/
鈹?  鈹?  鈹溾攢鈹€ User.kt              # Domain models
鈹?  鈹?  鈹斺攢鈹€ ApiResponse.kt       # Response envelopes
鈹?  鈹溾攢鈹€ services/
鈹?  鈹?  鈹溾攢鈹€ UserService.kt       # Business logic
鈹?  鈹?  鈹斺攢鈹€ AuthService.kt       # Auth logic
鈹?  鈹溾攢鈹€ repositories/
鈹?  鈹?  鈹溾攢鈹€ UserRepository.kt    # Data access interface
鈹?  鈹?  鈹斺攢鈹€ ExposedUserRepository.kt
鈹?  鈹斺攢鈹€ di/
鈹?      鈹斺攢鈹€ AppModule.kt         # Koin modules
src/test/kotlin/
鈹溾攢鈹€ com/example/
鈹?  鈹溾攢鈹€ routes/
鈹?  鈹?  鈹斺攢鈹€ UserRoutesTest.kt
鈹?  鈹斺攢鈹€ services/
鈹?      鈹斺攢鈹€ UserServiceTest.kt
```
...
fun Application.configureWebSockets() {
    install(WebSockets) {
        ...
        timeout = 15.seconds
        maxFrameSize = 64 * 1024 // 64 KiB 鈥?increase only if your protocol requires larger frames
