...
```
tests/
鈹溾攢鈹€ conftest.py                 # Shared fixtures
鈹溾攢鈹€ __init__.py
鈹溾攢鈹€ unit/                       # Unit tests
鈹?  鈹溾攢鈹€ __init__.py
鈹?  鈹溾攢鈹€ test_models.py
鈹?  鈹溾攢鈹€ test_utils.py
鈹?  鈹斺攢鈹€ test_services.py
鈹溾攢鈹€ integration/                # Integration tests
鈹?  鈹溾攢鈹€ __init__.py
鈹?  鈹溾攢鈹€ test_api.py
鈹?  鈹斺攢鈹€ test_database.py
鈹斺攢鈹€ e2e/                        # End-to-end tests
    鈹溾攢鈹€ __init__.py
    鈹斺攢鈹€ test_user_flow.py
```
