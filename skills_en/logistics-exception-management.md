...
- **Damage (concealed):** Discovered after delivery, not noted on POD. Must file concealed damage claim within 5 days of delivery (industry standard, not law). Burden of proof shifts to shipper. Carrier will challenge 鈥?you need packaging integrity evidence.
...
- **Shortage:** Piece count discrepancy at delivery. Count at the tailgate 鈥?never sign clean BOL if count is off. Distinguish driver count vs warehouse count conflicts. OS&D (Over, Short & Damage) report required.
- **Overage:** More product delivered than on BOL. Often indicates cross-shipment from another consignee. Trace the extra freight 鈥?somebody is short.
...
- **Misdelivered:** Delivered to wrong address or wrong consignee. Full carrier liability. Time-critical to recover 鈥?product deteriorates or gets consumed.
...
- **FTL/truckload** (asset carriers + brokers): Single-driver, dock-to-dock. Damage is usually loading/unloading. Brokers add a layer 鈥?the broker's carrier may go dark. Always get the actual carrier's MC number.
- **Parcel** (UPS, FedEx, USPS): Automated claims portals. Strict documentation requirements. Declared value matters 鈥?default liability is very low ($100 for UPS). Must purchase additional coverage at shipping.
...
- **Filing deadline:** 9 months from delivery date for US domestic (49 USC 搂 14706). Miss this and the claim is time-barred regardless of merit.
...
- **Systematic shortages:** Consistent 1-2 unit shortages across multiple shipments 鈥?indicates pilferage at a terminal or during transit.
...
**Customer Impact:**
- Standard customer, no SLA at risk 鈫?does not elevate
- Key account with SLA at risk 鈫?elevate by 1 level
- Enterprise customer with penalty clauses 鈫?elevate by 2 levels
- Customer's production line or retail launch at risk 鈫?automatic Level 4+

**Time Sensitivity:**
- Standard transit with buffer 鈫?does not elevate
- Delivery needed within 48 hours, no alternative sourced 鈫?elevate by 1
- Same-day or next-day critical (production shutdown, event deadline) 鈫?automatic Level 4+
...
1. Safety/regulatory (temperature-controlled pharma, hazmat) 鈥?always first
2. Customer production shutdown risk 鈥?financial multiplier is 10-50x product value
...
1. **Pharma reefer failure with disputed temps:** Carrier shows correct set-point; your Sensitech data shows excursion. The dispute is about sensor placement and pre-cooling. Never accept carrier's single-point reading 鈥?demand continuous data logger download.
...
5. **Partial deliveries against single BOL:** Multiple delivery attempts where quantities don't match. Maintain a running tally. Don't file shortage claim until all partials are reconciled 鈥?carriers will use premature claims as evidence of shipper error.
...
8. **Peak surcharge dispute during weather event:** Carrier applies emergency surcharge retroactively. Contract may or may not allow this 鈥?check force majeure and fuel surcharge clauses specifically.
...
- **Routine exception, good carrier relationship:** Collaborative. "We've got a delay on PRO# X 鈥?can you get me an updated ETA? Customer is asking."
...
**Initial carrier inquiry:** Subject: `Exception Notice 鈥?PRO# {pro} / BOL# {bol}`. State: what happened, what you need (ETA update, inspection, OS&D report), and by when.
...
**Escalation to carrier management:** Subject: `ESCALATION: Unresolved Exception 鈥?{shipment_ref} 鈥?{days} Days`. Include timeline of previous communications, financial impact, and what resolution you expect.
...
Level 1 (Analyst) 鈫?Level 2 (Team Lead, 4 hours) 鈫?Level 3 (Manager, 24 hours) 鈫?Level 4 (Director, 48 hours) 鈫?Level 5 (VP, 72+ hours or any Level 5 severity)
