...
description: "Patterns and architectures for autonomous Claude Code loops 鈥?from simple sequential pipelines to RFC-driven multi-agent DAG systems."
---
...
```bash
#!/bin/bash
# daily-dev.sh 鈥?Sequential pipeline for a feature branch
...
1. **Each step is isolated** 鈥?A fresh context window per `claude -p` call means no context bleed between steps.
2. **Order matters** 鈥?Steps execute sequentially. Each builds on the filesystem state left by the previous.
3. **Negative instructions are dangerous** 鈥?Don't say "don't test type systems." Instead, add a separate cleanup step (see [De-Sloppify Pattern](#5-the-de-sloppify-pattern)).
4. **Exit codes propagate** 鈥?`set -e` stops the pipeline on failure.
...
鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?            鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?鈹?Parse spec file      鈹?            鈹?Receive full context  鈹?鈹?Scan output dir      鈹? deploys   鈹?Read assigned number  鈹?鈹?Plan iteration       鈹傗攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?Follow spec exactly   鈹?鈹?Assign creative dirs 鈹? N agents  鈹?Generate unique output 鈹?鈹?Manage waves         鈹?            鈹?Save to output dir    鈹?鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?            鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?```

### The Pattern

1. **Spec Analysis** 鈥?Orchestrator reads a specification file (Markdown) defining what to generate
2. **Directory Recon** 鈥?Scans existing output to find the highest iteration number
3. **Parallel Deployment** 鈥?Launches N sub-agents, each with:
   - The full spec
   - A unique creative direction
   - A specific iteration number (no conflicts)
   - A snapshot of existing iterations (for uniqueness)
4. **Wave Management** 鈥?For infinite mode, deploys waves of 3-5 agents until context is exhausted
...
1. spec_file 鈥?path to the specification markdown
2. output_dir 鈥?where iterations are saved
3. count 鈥?integer 1-N or "infinite"

PHASE 1: Read and deeply understand the specification.
PHASE 2: List output_dir, find highest iteration number. Start at N+1.
PHASE 3: Plan creative directions 鈥?each agent gets a DIFFERENT theme/approach.
...
```
鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?鈹? CONTINUOUS CLAUDE ITERATION                        鈹?鈹?                                                    鈹?鈹? 1. Create branch (continuous-claude/iteration-N)   鈹?鈹? 2. Run claude -p with enhanced prompt              鈹?鈹? 3. (Optional) Reviewer pass 鈥?separate claude -p   鈹?鈹? 4. Commit changes (claude generates message)       鈹?鈹? 5. Push + create PR (gh pr create)                 鈹?鈹? 6. Wait for CI checks (poll gh pr checks)          鈹?鈹? 7. CI failure? 鈫?Auto-fix pass (claude -p)         鈹?鈹? 8. Merge PR (squash/merge/rebase)                  鈹?鈹? 9. Return to main 鈫?repeat                         鈹?鈹?                                                    鈹?鈹? Limit by: --max-runs N | --max-cost $X             鈹?鈹?           --max-duration 2h | completion signal     鈹?鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?```
...
```
RFC/PRD Document
       鈹?       鈻?  DECOMPOSITION (AI)
  Break RFC into work units with dependency DAG
       鈹?       鈻?鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?鈹? RALPH LOOP (up to 3 passes)                         鈹?鈹?                                                     鈹?鈹? For each DAG layer (sequential, by dependency):     鈹?鈹?                                                     鈹?鈹? 鈹屸攢鈹€ Quality Pipelines (parallel per unit) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹? 鈹?鈹? 鈹? Each unit in its own worktree:                鈹? 鈹?鈹? 鈹? Research 鈫?Plan 鈫?Implement 鈫?Test 鈫?Review   鈹? 鈹?鈹? 鈹? (depth varies by complexity tier)             鈹? 鈹?鈹? 鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹? 鈹?鈹?                                                     鈹?鈹? 鈹屸攢鈹€ Merge Queue 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹? 鈹?鈹? 鈹? Rebase onto main 鈫?Run tests 鈫?Land or evict 鈹? 鈹?鈹? 鈹? Evicted units re-enter with conflict context  鈹? 鈹?鈹? 鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹? 鈹?鈹?                                                     鈹?鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?```
...
```
Layer 0: [unit-a, unit-b]     鈫?no deps, run in parallel
Layer 1: [unit-c]             鈫?depends on unit-a
Layer 2: [unit-d, unit-e]     鈫?depend on unit-c
```
...
|------|----------------|
| **trivial** | implement 鈫?test |
| **small** | implement 鈫?test 鈫?code-review |
| **medium** | research 鈫?plan 鈫?implement 鈫?test 鈫?PRD-review + code-review 鈫?review-fix |
| **large** | research 鈫?plan 鈫?implement 鈫?test 鈫?PRD-review + code-review 鈫?review-fix 鈫?final-review |
...
**Critical design:** The reviewer never wrote the code it reviews. This eliminates author bias 鈥?the most common source of missed issues in self-review.
...
```
Unit branch
    鈹?    鈹溾攢 Rebase onto main
    鈹?  鈹斺攢 Conflict? 鈫?EVICT (capture conflict context)
    鈹?    鈹溾攢 Run build + tests
    鈹?  鈹斺攢 Fail? 鈫?EVICT (capture test output)
    鈹?    鈹斺攢 Pass 鈫?Fast-forward main, push, delete branch
```
...
```markdown
## MERGE CONFLICT 鈥?RESOLVE BEFORE NEXT LANDING
...
```
research.contextFilePath 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈫?plan
plan.implementationSteps 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈫?implement
implement.{filesCreated, whatWasDone} 鈹€鈹€鈹€鈹€鈹€鈫?test, reviews
test.failingSummary 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈫?reviews, implement (next pass)
reviews.{feedback, issues} 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈫?review-fix 鈫?implement (next pass)
final-review.reasoning 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈫?implement (next pass)
evictionContext 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈫?implement (after merge conflict)
```
...
Pipeline stages for the same unit **share** a worktree, preserving state (context files, plan files, code changes) across research 鈫?plan 鈫?implement 鈫?test 鈫?review.

### Key Design Principles

1. **Deterministic execution** 鈥?Upfront decomposition locks in parallelism and ordering
2. **Human review at leverage points** 鈥?The work plan is the single highest-leverage intervention point
3. **Separate concerns** 鈥?Each stage in a separate context window with a separate agent
4. **Conflict recovery with context** 鈥?Full eviction context enables intelligent re-runs, not blind retries
5. **Tier-driven depth** 鈥?Trivial changes skip research/review; large changes get maximum scrutiny
6. **Resumable workflows** 鈥?Full state persisted to SQLite; resume from any point
...
鈹溾攢 Yes 鈫?Sequential Pipeline or NanoClaw
鈹斺攢 No 鈫?Is there a written spec/RFC?
         鈹溾攢 Yes 鈫?Do you need parallel implementation?
         鈹?       鈹溾攢 Yes 鈫?Ralphinho (DAG orchestration)
         鈹?       鈹斺攢 No 鈫?Continuous Claude (iterative PR loop)
         鈹斺攢 No 鈫?Do you need many variations of the same thing?
                  鈹溾攢 Yes 鈫?Infinite Agentic Loop (spec-driven generation)
                  鈹斺攢 No 鈫?Sequential Pipeline with de-sloppify
```
...
1. **Sequential Pipeline + De-Sloppify** 鈥?The most common combination. Every implement step gets a cleanup pass.

2. **Continuous Claude + De-Sloppify** 鈥?Add `--review-prompt` with a de-sloppify directive to each iteration.

3. **Any loop + Verification** 鈥?Use ECC's `/verify` command or `verification-loop` skill as a gate before commits.

4. **Ralphinho's tiered approach in simpler loops** 鈥?Even in a sequential pipeline, you can route simple tasks to Haiku and complex tasks to Opus:
   ```bash
...
1. **Infinite loops without exit conditions** 鈥?Always have a max-runs, max-cost, max-duration, or completion signal.

2. **No context bridge between iterations** 鈥?Each `claude -p` call starts fresh. Use `SHARED_TASK_NOTES.md` or filesystem state to bridge context.

3. **Retrying the same failure** 鈥?If an iteration fails, don't just retry. Capture the error context and feed it to the next attempt.

4. **Negative instructions instead of cleanup passes** 鈥?Don't say "don't do X." Add a separate pass that removes X.

5. **All agents in one context window** 鈥?For complex workflows, separate concerns into different agent processes. The reviewer should never be the author.

6. **Ignoring file overlap in parallel work** 鈥?If two parallel agents might edit the same file, you need a merge strategy (sequential landing, rebase, or conflict resolution).
